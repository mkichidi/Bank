...
namespace Bank
{
    public partial class PassBook : Form
    {
        ...
        public void IncrementShipment()
        {
            ...
            SqlCommand cmd = new SqlCommand("GetMaxBankTransaction", con);
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
       {
        ...
        public void BindGrid()
        {
            ...
            { 
            SqlConnection con = new SqlConnection(Connection.InvAdminConn());
            SqlCommand cmd = new SqlCommand("GetBankTransaction", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void tsBtnSave_Click(object sender, EventArgs e)
        {
            ...
            //    return;
            //}
            else if (((string.IsNullOrEmpty(TxtDeposit.Text) && !string.IsNullOrEmpty(TxtWithdraw.Text)) || Convert.ToString(DdlBankGroup.SelectedValue)=="9")&& !string.IsNullOrEmpty(TxtChequeNo.Text))
            {
                SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                SqlCommand cmd = new SqlCommand("CheckChequeNoPassbook", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Account", DdlAccount.SelectedValue);
            ...
            {
                SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                SqlCommand cmd = new SqlCommand("InsertBankTransaction", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (cmd.ExecuteNonQuery() > 0)
                {
                    MessageBox.Show("Passbook Entry Saved Succesfully");
                    IncrementShipment();
                    BindGrid();
                    clear();
                }
                ...
                {
                    MessageBox.Show("Passbook Entry already exists");
                }
                con.Close();
            }
            ...
            {
                SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                SqlCommand cmd = new SqlCommand("UpdateBankTransaction", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (cmd.ExecuteNonQuery() > 0)
                {
                    MessageBox.Show("Passbook Entry Edited Succesfully");
                    IncrementShipment();
                    BindGrid();
                    clear();
                    EditId = string.Empty;
        ...
        private void tsBtnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                SqlCommand cmd = new SqlCommand("GetBankTransactionOnId", con);
                ...
                if (dataTable.Rows.Count > 0)
                {
                    TxtShipmentID.Text = Convert.ToString(dataTable.Rows[0]["BankTransactionId"]);
                    ...
                    TxtDeposit.TextChanged += TxtDeposit_TextChanged;
                    DdlAccount.SelectedValue = Convert.ToInt32(dataTable.Rows[0]["BankAccount"]);
